r"""
This file was *autogenerated* from slides.tex with sagetex.sty
version 2019/11/14 v3.4. It contains the contents of all the
sageexample environments from slides.tex. You should be able to
doctest this file with "sage -t slides_doctest.sage".
