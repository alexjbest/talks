...
\begin{frame}
  ...
  \note[item]{Thank the audience for attending remotely in times of Covid.}
\end{frame}
...
\begin{frame}{Overview}
    ...
    \begin{centering}
        \url{https://alexjbest.github.io/talks/motivation-for-p-adic-modular-forms/slides_h.pdf}
    \end{centering} \note{to read along check back definitions, link will be at the bottom of all slides, pls no skip}\pause
