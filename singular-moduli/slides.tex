...
Every lattice is homothetic to one of the form $\ZZ + \ZZ\tau$ for some $\tau \in \CC$ with positive imaginary part.

We can define $j$ on the upper half plane by $j(\tau) = j(\ZZ + \ZZ\tau)$.
